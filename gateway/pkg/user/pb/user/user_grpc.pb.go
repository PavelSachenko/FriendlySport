...
func (c *userServiceClient) One(ctx context.Context, in *OneRequest, opts ...grpc.CallOption) (*OneResponse, error) {
	out := new(OneResponse)
	err := c.cc.Invoke(ctx, "/UserService.UserService/One", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserServiceServer) One(context.Context, *OneRequest) (*OneResponse, error) {
...
func _UserService_One_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/UserService.UserService/One",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).One(ctx, req.(*OneRequest))
	}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "pkg/user/pb/user/user.proto",
}
